    ...
    def solve(self) -> Tuple[List[Union[Hotel, Landmark]], float]:
        ...
        for gen in range(self.generations):
            ...
            for _ in range(self.num_ants):
                ...
                generation_trips.append((ant.path, ant.total_score))
                
                # Check if this ant beat the all-time world record
                if ant.total_score > self.global_best_score:
                    self.global_best_score = ant.total_score
